...
<nav class="toolbar">
    <div class="toolbar-left">
        <a href="pasajero.php" class="nav-link active">Inicio</a>
        <a href="buscarRides.php" class="nav-link">Buscar Rides</a>
        <a href="misReservas.php" class="nav-link">Mis Reservas</a>
    </div>
...
<section class="container">
    ...
    <div class="opciones">
        ...
        <div class="opcion">
            ...
            <a href="misReservas.php" class="btn btn-green">Ver Reservas</a>
        </div>
    </div>
</section>
